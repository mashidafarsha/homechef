...
router.get('/',async function(req, res, next) {
 ...
 res.render('user/view-products',{userData,product,user:true,cartCount});
...
router.get('/view-order-products/:_id',async(req,res)=>{
...
router.get('/view-bakers',async(req,res)=>{
